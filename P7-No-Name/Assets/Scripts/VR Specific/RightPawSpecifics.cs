...
public class RightPawSpecifics : MonoBehaviour {
    ...
    private void Start()
    {
        digArea = GameObject.FindGameObjectWithTag("DiggingRange");
    ...
    private void DoTriggerPressed(object sender, ControllerInteractionEventArgs e)
    {
        ...
        scriptHolder.GetComponent<Master>().CurlRightPaw();
    ...
    private void DoTriggerReleased(object sender, ControllerInteractionEventArgs e)
    {
        ...
        scriptHolder.GetComponent<Master>().UncurlRightPaw();
